...
tab1, tab2, tab3 = st.tabs(["🤖 Real-Time AI Signals", "📊 Daily RRG Chart (With Arrows)", "📸 Chart Analyzer"])
...
# --- TAB 2: DAILY RRG CHART WITH ARROWS ---
with tab2:
    st.subheader("📊 Daily Relative Rotation Graph (With Trend Arrows)")
    st.write("Teer (Arrow) ka nishan dikhata hai ki pichle kuch dino me coin kis direction me rotate ho raha hai.")
    
    if st.button("Generate Daily RRG Chart"):
        with st.spinner("Daily RRG Arrow Plot ho raha hai..."):
            symbols = ["ETH-USD", "SOL-USD", "XRP-USD", "ADA-USD", "BNB-USD"]
            benchmark = "BTC-USD"
            ...
            try:
                ...
                ax.set_title("Daily RRG Rotation vs BTC Benchmark")
